...
<body>
    <div class="form">
        ...
        <form method="GET">
            ...
            INTEREST <input type="checkbox" id="basketball" name="interest[]" value="Basketball" style="margin-left:10px;">
            <label for="basketball">BasketBall</label> 
            <input type="checkbox" id="gaming" name="interest[]"  value="Gaming" style="margin-left:10px;">
            <label for="gaming">Gaming</label>
            <input type="checkbox" id="pentesting" name="interest[]"  value="Pentesting" style="margin-left:10px;">
            <label for="pentesting">Pentesting</label>
            <input type="checkbox" id="gym" name="interest[]" value="Gym" style="margin-left:10px;">
            <label for="gym">Gym</label><br><br>
...
if(isset($_GET['submit'])){
    ...
    <tr><td>$name</td><td>$email</td><td>$contact</td><td>$city</td><td>$course</td><td>$selected</td></tr></table>";
}
?>
    <script>
